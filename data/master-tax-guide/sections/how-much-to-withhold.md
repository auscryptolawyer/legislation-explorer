...
In working out how much to withhold under the withholding schedules, a payer may disregard any part of a payment that is paid, or is to be paid, as a donation to a deductible gift recipient at the direction of the payee under a regular planned giving arrangement, unless the payee advises the payer of a variation to the amount withheld (Legislative Instrument F2016L01641). Where donations are made to a deductible gift recipient under an occasional workplace giving arrangement then the withholding is calculated as follows: step 1 — calculate the amount required to be withheld from the withholding payment by using the relevant withholding schedule; step 2 — multiply the amount of the donation to the deductible gift recipient under the occasional giving arrangement by 0.32; and step 3 — subtract the result of step 2 from the result of step 1. If the amount calculated in step 3 is zero or negative, the amount that a payer must withhold from the payment is varied to nil (Legislative Instrument F2024L00130).

The PAYG withholding schedules for 2024–25 and subsequent years are in Legislative Instrument F2024L00664. This instrument not only deals with amounts to be withheld from salary and wages, but also covers PAYG on back payments, commissions, bonuses and payments made to working holiday makers.

Withholding rates Withholding payment                                                                 How much to withhold Salary, wages, etc, of an employee Remuneration of a director or oﬃce holder Payment to a religious practitioner Return to work payment Payment under a labour hire arrangement                                            The amount worked out under the withholding schedules, Payment speciﬁed by regulations                                                    based on progressive rates. Where the payee has not Superannuation income stream or annuity                                            provided a TFN declaration, 47% of the payment to be withheld.

*Refs: s 15-10), s 15-35), s 15-25*

required to be withheld.

payment Unused leave payment Social security and other beneﬁt payment Commonwealth education or training payment Compensation, sickness or accident payment Alienated personal services payment Payment from an investment where the investor does              47% of the payment, unless it is a partly franked dividend not quote a TFN or, in some cases, an ABN (including            (in which case the 47% rate applies only to the unfranked becoming presently entitled to income of a unit trust)          portion). These rules, in TAR s 35, are subject to special rules in TAR s 28 where the investor is a minor.

Accrued gain in relation to a Pt VA investment                  47% of the accrued gain.
...
Departing Australia superannuation payment                      For tax free component — nil.

For untaxed element of the taxable component — 45%.

— 65%.

Remainder — 35%.

Departing Australia superannuation payment that is a roll- For amount that is not an excess untaxed roll-over amount over superannuation beneﬁt paid to a former temporary           — 45%. resident                                                        For amount that is an excess untaxed roll-over amount — nil.

Payment to foreign residents                                    Amount speciﬁed in the regulations. Where the payee has not provided a TFN declaration, 45% of the payment is withheld.

Payment under certain labour mobility programs                  15% of the payment.

Payment to working holiday makers                               Up to a taxable income of $45,000 — 15%.

rates.

Mining payment                                                  4% of the payment (TAR s 53).

Natural resource payment                                        The rate set by the Commissioner.

Excess untaxed roll-over amount                                 47% of the amount.

Distributions of withholding MIT income                         Where the income is non-concessional MIT income (NCMI) and the transitional exclusions do not apply, or the recipient is not in an exchange of information jurisdiction — 30%.

jurisdiction and the payment relates to payments from a clean building MIT — 10%.
...
Employee share schemes where TFN not quoted                     47% of the assessable discount.

Disposal of CGT assets by foreign residents                     15% of the purchase price.

Withholding of GST from certain real estate supplies                               1/11th of the contract price. If the margin scheme applies, 7% of the contract price (or such percentage as has been determined by legislative instrument).
...
Planning point A salaried individual who is entitled to signiﬁcant deductions during an income year (eg if he/she enters into a negatively geared investment) may ask the ATO to vary the PAYG withholding rate, thus increasing take-home pay. It would, of course, be an oﬀence to knowingly or recklessly make a false or misleading statement in a variation request (¶29-700).

*Refs: s 15-15)*

## Note that a voluntary agreement may aﬀect how much is

## Superannuation lump sum or employment termination

## For a person who was a temporary working holiday maker

## Taxable income $45,001 and above — normal marginal

## Where the recipient is in an exchange of information

## Where the recipient is in an exchange of information

## If the instalment rate is greater than 20%, the payer must

## If the Commissioner is unable to make an estimate — 17%