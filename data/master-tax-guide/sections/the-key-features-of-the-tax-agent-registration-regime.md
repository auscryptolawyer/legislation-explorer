...
part: "32"
section: "the-key-features-of-the-tax-agent-registration-regime"
...
Period of registration As the TASA was originally enacted, the period of registration was for at least 3 years. The registration period has been reduced to one year as a result of amendments that apply in relation to applications for registration or re-registration made on or after 1 July 2024.
...
- where a false or misleading statement is made by a taxpayer’s agent carelessly, provided the
  ...
  a decision in which this safe harbour was considered, see Automotive Invest Pty Ltd 2022 ATC

¶10-626; [2022] AATA 673), and
...
- where a document (such as a return, notice or statement) is not lodged on time in the approved
  ...
  approved form (TAA sch 1 s 284-75).

The register The TPB must establish, and maintain, a register of entities in accordance with the TASA and the regulations (TASA s 60-135). The information that must now be included on the register includes basic information (name, contact details, etc), details of registration applications rejected on integrity grounds and details of TPB orders, suspensions and terminations for misconduct. Also, if the TPB so decides, details of a TPB investigation ﬁnding that an entity breached the TASA may be included.

Legal practitioners The general position is that a barrister or solicitor may provide a taxation service as a legal service without being a registered tax agent (¶32-015).

*Refs: s 284-75), s 60-135)*