...
part: "32"
section: "tax-agent-registration-rules"
...
- maintains (or will be able to maintain) professional indemnity insurance that meets the TPB’s
  ...
  requirements (TPB(EP) 03/2010), and

- in the case of a renewal of registration, has completed continuing professional education that

  meets the TPB’s requirements (TASA s 20-5(1)).
...
- the partnership maintains (or will be able to maintain) professional indemnity insurance that meets

  the TPB’s requirements (TASA s 20-5(2)).
...
The registration application An application for registration as a tax agent must be made in an approved form and be accompanied by any required supporting document and the prescribed fee (TASA s 20-20).

The TPB must decide an application for registration within 6 months of receiving it and (unless the application is for re-registration) is taken to have rejected it if it has not been decided within that time.

Registration is for the period determined by the TPB, but must be for at least 3 years or, if the application is made on or after 1 July 2024, one year.

Renewal of registration An application for renewal of registration is determined by the TPB on the same basis as an original application for registration. However, the application for renewal must be made at least 30 days (but not more than 90 days) before the day on which the existing registration expires or within such shorter period as the TPB allows (TASA s 20-50). The existing registration is taken to continue until the application for renewal has been decided.

Review of decision A decision by the TPB to refuse registration or re-registration is reviewable on its merits by the ART.

*Refs: s 20-5(1)), s 20-5(4)), s 20-5(3)), s 20-5(2)), s 20-20), s 20-50)*