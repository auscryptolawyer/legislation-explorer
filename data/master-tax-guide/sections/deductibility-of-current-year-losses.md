...
part: "03"
section: "deductibility-of-current-year-losses"
...
- the company does not satisfy the continuity of ownership test (¶3-105, ¶3-130) or the business

  continuity test (¶3-120 – ¶3-125) for the whole income year, or
...
The company calculates its taxable income in the following way.

Step 1: The income year is divided into periods (s 165-45), with each change in ownership or control a dividing point between periods.

Step 2: Each period is treated as if it were an income year, and the notional loss or taxable income is worked out for that period (s 165-50).

Step 3: The taxable income for the year of change is worked out by adding up: (a) each notional taxable income; and (b) any full year amounts (ie amounts of assessable income not taken into account at Step 2), then subtracting any full year deductions (ie deductions not taken into account at Step 2) (s 165-65). A notional loss is not taken into account when calculating taxable income, but counts towards the company’s tax loss.
...
## The current year loss rules are applied if: