...
part: "39"
section: "calculating-an-individual-employees-shortfall"
...
The SG shortfall calculation process involves the following steps: Step 1: Determine the charge percentage that applies for the year (¶39-100).

Step 2: Determine the actual percentage level of superannuation support that is provided for each employee (or the total of the percentage levels if support is provided in more than one fund) (¶39-230).
...
An employer that has an SG shortfall in a quarter is required to lodge an SG statement with the ATO by the 28th day of the second month following the end of the quarter (¶39-500).
...
If an employer’s individual SG shortfall is reduced in the above circumstances, the late contribution (which triggered the discretion being exercised) cannot be taken into account in relation to any other quarter when reducing the charge percentage calculation so as to prevent double counting of the late contribution (s 23(8AA): ¶39-230).
...
The employer pays salary or wages accrued for the period 1 April to 10 April to the executor of Barry’s estate on 18 April, but does not make SG contributions to a complying superannuation fund for Barry for the 1 April to 30 June quarter.

The employer will have an individual SG shortfall in respect of Barry for the quarter in which the salary or wages were paid to the Barry’s estate.

Penalty for failure to comply with choice of fund rules An increased SG shortfall amount arises as an additional penalty if an employer fails to comply with the choice of fund requirements (¶39-260).

## Step 3: Compare the percentage levels in steps 1 and 2:

## Reduction of SG shortfall for late contribution due to