...
part: "13"
section: "superannuation-fund-tax-returns-and-assessments"
...
- a non-resident and it derived income (including capital gains) that is taxable in Australia (other

  than dividend, interest or royalty income and payments from managed investment trusts that are

  subject to withholding tax).

The exceptions apply to the trustees of exempt state or territory funds and corporate trustees which are subsidiary members of a consolidated or MEC group with respect to their consolidated activities.

The approved form for SMSFs is the Self-managed superannuation fund annual return and for other superannuation entities is the Fund income tax return for the relevant income tax year.

Superannuation entities are subject to self-assessment and their assessments are deemed to be made on the day they lodge their tax return with the ATO in each year. The self-assessment system and tax return lodgment requirements are discussed in detail at ¶24-000, ¶24-060 and following.

Lodgment of member information statements and annual return

- all superannuation funds must lodge member information statements with the ATO under TAA sch

  1 s 390-5 (¶39-530), and

- SMSFs are required to lodge an annual return with the ATO under SISA s 35D, and non-SMSFs

  are required to lodge annual and periodic returns with APRA under the Financial Sector (Collection

  of Data) Act 2001.

The return required under s 35D forms part of the Self-managed superannuation fund annual return that is lodged with the ATO for each income tax year.

Superannuation entities are also liable to pay a supervisory levy each year (¶13-935).

Australian funds Transfers between KiwiSaver schemes and Australian funds The Arrangement between the Government of Australia and the Government of New Zealand on Trans- Tasman Retirement Savings Portability (Arrangement) 2009 established a scheme under which Australians and New Zealanders can transfer their retirement savings when they move between Australia and New Zealand, while preserving the integrity of the retirement savings systems of both countries. The key features of the Arrangement are:

- individuals may transfer their retirement savings between Australian complying superannuation
...
- the transfer of retirement savings is voluntary for members, and it is voluntary for funds to accept

  the transferred savings (SISR regs 12A.07(3); 12A.08(4))
...
- New Zealand-sourced retirement savings transferred to Australia are subject to the

  non-concessional contributions cap arrangements on their initial entry into the Australian

  superannuation system.

ITAA97 Div 312 provides for the tax treatment of transactions under the Arrangement, covering:
...
A “KiwiSaver scheme” has the meaning given by s 4 of the KiwiSaver Act 2006 of New Zealand, and a “KiwiSaver scheme provider” means a provider within that Act (ITAA97 s 995-1(1)).

*Refs: s 390-5, ITAA97 s 995-1(1))*
...
- may only be transferred to and held in APRA-regulated complying superannuation funds

- may not be transferred to or held in SMSFs (SISR reg 12A.07(2))
...
- payments made between complying superannuation funds under the portability provisions (SISR

- payments made between complying superannuation funds where the member’s interest in the

  fund is, or includes, a New Zealand-sourced amount but the payment does not include a New
...
Contribution to complying superannuation fund from KiwiSaver schemes An amount transferred from a KiwiSaver scheme to a complying superannuation fund is treated as a personal contribution of the person for whom the transfer is made (ITAA97 s 312-10(1)). The tax and regulatory consequences are summarised below.

Not assessable contribution of Australian superannuation fund An amount transferred from a KiwiSaver scheme to a complying superannuation fund as a contribution is not assessable income of the fund. This means that the contribution is not subject to the tax arrangements for transfers from foreign superannuation funds under ITAA97 s 295-200 (¶13-125) and Subdiv 305-B (¶14-420) (s 312-10(1) Note 1, (2)).
...
Departing Australian superannuation payments An amount transferred from a complying superannuation fund to a KiwiSaver scheme is not taxed on its exit from the Australian superannuation system. The departing Australia superannuation payment regime does not apply to Australian and New Zealand citizens and permanent residents (¶14-390).

*Refs: s 390-12)*

## In addition to the income tax return:
...
## Australian-sourced amounts held in KiwiSaver schemes:

## New Zealand-sourced amounts held in Australian superannuation funds:

## Superannuation entities, payments and interests

## The scheme in Pt 12A applies to:

## Div 6.5) where the payment includes a New Zealand-sourced amount, and

## Part 12A does not apply in relation to:

## Australian funds

## No deduction or tax offset for amounts transferred from KiwiSaver

## Providing statements about benefits paid to KiwiSaver