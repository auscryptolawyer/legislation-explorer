...
part: "44"
section: "death-of-taxpayer-tax-checklist"
...
- In the date of death return, the deceased is entitled to the normal tax-free threshold even though
...
- The Commissioner may make an arbitrary assessment of the tax payable where the LPR fails to

  furnish a return, or probate is not taken out within a certain period (¶25-530).
...
- Pre-CGT assets are deemed to have been acquired for a consideration equal to their market price

  at the date of death (¶12-580).

- Post-CGT assets are generally deemed to have been acquired for a consideration equal to the
...
- Eligible costs incurred in relation to an asset after the date of death may also enter into the
  ...
  calculation of the cost price (¶12-580).

- Assets acquired subsequent to the date of death are subject to the normal CGT rules relating to
...
- Special cost base rules apply where the surviving joint tenant acquires the interest of a deceased

  joint tenant in the asset (¶12-580).
...
- Lump sum life insurance proceeds are not assessable as income, and CGT does not apply where

  the recipient was the original owner or acquired the policy for no consideration (¶10-230, ¶11-880).

- Bequests of an asset or sum of money are normally not assessable income, unless related to

  performance of executorial duties (¶10-840). For CGT implications in the case of assets, see
...
- Interest on money borrowed to satisfy a Supreme Court order under testator family maintenance

  provisions was not deductible (¶16-740).

- Dividends declared on shares owned by a deceased estate, but not paid over until after the

  production of probate, are not assessable until actually paid over (¶4-120).

- A deductible gift cannot be made by will, though testamentary gifts of property are CGT-exempt

  (¶11-670, ¶16-942).

- Where a primary producer dies and the LPR continues the business, there is a new taxpayer and

  a new averaging calculation applies for the LPR (¶18-200).

- Where the deceased held depreciating assets, a balancing adjustment may arise on death

  (¶17-640).

- A taxpayer who dies while on service in a qualifying overseas locality is entitled to the full amount

  of the overseas defence forces rebate, irrespective of the time served (¶15-180).

- The estate of a deceased Defence Force member may be entitled to be released from any unpaid
...
## After period of administration

## Capital gains tax

## Termination, superannuation and insurance

## Specific assets, income and expenses

## State duties, land tax and other considerations