...
part: "10"
section: "when-a-tax-exempt-entity-becomes-taxable"
...
- deny deductions for superannuation payments, bad debts, R&D expenditure, eligible termination
  ...
  disallowed is reduced where such a debt is sold at or after the transition time

- ensure changes in the value of trading stock are calculated from the time the entity becomes
...
- cancel the franking surplus of a wholly-owned subsidiary of a tax-exempt entity when that entity
