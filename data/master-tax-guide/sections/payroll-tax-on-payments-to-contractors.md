...
part: "36"
section: "payroll-tax-on-payments-to-contractors"
...
- The services provided are not normally required by the business receiving the services and the
...
- Services provided under contract are ordinarily rendered to the general public.

- The services under the contract are provided by 2 or more persons supplied by the contractor.

- The services are those of an owner/driver, an insurance agent or a direct selling agent. Note that

  the exemptions that apply in relation to insurance agents and direct selling agents are not available

  in New South Wales, Tasmania, the Northern Territory and the ACT.
