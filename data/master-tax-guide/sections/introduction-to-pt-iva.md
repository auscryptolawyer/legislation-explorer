...
part: "30"
section: "introduction-to-pt-iva"
...
The Commissioner also will not need to rely on Pt IVA if the transaction is a sham, and not intended to have legal eﬀect, as that transaction will be inherently ineﬀective (Jaques (1924) 34 CLR 328, Hancock (1961) 108 CLR 285, Richard Walter 96 ATC 4550; [1996] FCA 454). However, when a transaction is evidenced by apparently valid documents it would be necessary to establish, to the satisfaction of the court, that those documents were not in fact acted upon or were a mere facade or cloak for some other transaction before the court could conclude that the transaction evidenced by the documents was a sham (Normandy Finance 2016 ATC ¶20-595; [2016] FCAFC 180).

Part IVA strengthened The government amended Pt IVA in 2013 to remedy deﬁciencies in ss 177C (tax beneﬁts) and 177D, as revealed by a number of Full Federal Court decisions, including RCI 2011 ATC ¶20-275; [2011] FCAFC 104 in 2011 (¶30-160) and Futuris 2012 ATC ¶20-306; [2012] FCAFC 32 in 2012 (¶30-160). Part IVA was amended to make it more eﬀective against tax avoidance schemes carried out as part of broader commercial transactions. The amendments apply in relation to schemes that were entered into, or that started to be carried out, on or after 16 November 2012.

Multinational tax avoidance measures The government has enacted a number of measures to address multinational tax avoidance, including:

- the doubling of administrative penalties that can be applied to large multinational companies

  entering tax avoidance or proﬁt shifting schemes (¶29-180)

- the multinational anti-avoidance law (MAAL) which targets multinational entities using artiﬁcial

  or contrived arrangements to avoid the attribution of business proﬁts to a taxable permanent

  establishment in Australia (¶30-200), and
...
Proposed Pt IVA expansion delayed The measure to expand the general anti-avoidance rule in Pt IVA announced in the 2023–24 Budget has been deferred from income years commencing on or after 1 July 2024 to income years commencing on or after the day the enabling legislation receives assent (2024–25 Budget Paper No 2, p 10). As announced, the general anti-avoidance rule will be expanded to cover schemes reducing Australian tax through lower withholding tax rates on income paid to foreign residents. The changes will also include extending Pt IVA to schemes primarily aimed at reducing foreign income tax while achieving an Australian income tax beneﬁt.