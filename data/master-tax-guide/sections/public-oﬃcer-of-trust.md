...
The appointment of a public oﬃcer must be made within 90 days after the earlier of: (a) the date on which any business was commenced to be carried on by the trust in Australia; or (b) the date on which the trust commences to derive relevant property income from Australian sources. Failure to appoint a public oﬃcer is a strict liability oﬀence that may result in a ﬁne not exceeding 1 penalty unit (¶29-000) for each day that an appointment is not duly made.