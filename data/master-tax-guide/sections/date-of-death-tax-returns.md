...
part: "02"
section: "date-of-death-tax-returns"
...
A date of death return does not have to be ﬁled if the taxpayer would not have been obliged to ﬁle a return, eg where the deceased taxpayer was a resident whose taxable income for the period to the date of death did not exceed the tax-free threshold and there are no other circumstances requiring lodgment of a return.

In such a case, the executor or administrator should instead provide the Commissioner with a non-lodgment advice. A pro forma is provided in the tax return instructions.

Note that, with limited exceptions, any capital gain or loss arising from a CGT event as a result of the death of a taxpayer is disregarded (¶12-570).
