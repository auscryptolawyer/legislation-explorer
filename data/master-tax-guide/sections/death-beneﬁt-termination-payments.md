...
part: "42"
section: "death-beneﬁt-termination-payments"
...
Component                                 Tax treatment Tax free component                        Not assessable income and not exempt income

- amount up to the ETP cap amount (see below) is not assessable income and not

  exempt income

- amount over the ETP cap amount is taxed at the top marginal rate (45%)

- amount up to the ETP cap amount is taxed at a maximum rate of 30%
...
## Taxable component                         Payment to a dependant:
