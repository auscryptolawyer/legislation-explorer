...
- up to 15% on earnings on superannuation balances below $3 million (as currently), and

- up to an overall 30% on a percentage of earnings equal to the percentage of superannuation
...
- individuals who have a structured settlement contribution made in respect to them as a payment

  for a personal injury at the end of the income year, or any year prior, and
...
- accumulation account: $3.2 million

- account-based pension: $1.6 million.
...
- have amount of tax payable released from any superannuation account of their choice (regardless

  of their age or the preservation status of the superannuation interest in the account).

Individuals with deﬁned beneﬁt interests can defer payment of the component of Division 296 tax that relates to their deﬁned beneﬁt interests to a Division 296 tax debt account. Full payment of the tax debt account must be made within 21 days when the individual ﬁrst starts to receive a beneﬁt from the fund holding the deﬁned beneﬁt interest.

Division 296 tax — special rules and modifications

- individuals with deﬁned beneﬁt interests

- State higher level oﬃce holders with superannuation contributions to constitutionally protected

  funds and/or other contributions made to non-constitutionally protected funds on their behalf
...
- to modify the operation of ss 296-50 and 296-55 and set out a non-exhaustive list of how those
  ...
  provisions may be modiﬁed (s 296-60(1))

- to declare individuals who hold an excluded interest in a constitutionally protected fund (s
...
- to specify a value or method for determining the TSB value of a superannuation interest (s

  307-230A(1)(a)).

Division 296 tax — draft regulations for consultation Draft regulations have been released proposing amendments to ITR2021 to ensure that all applicable superannuation interests are properly assessed for Division 296 tax purposes.

The amendments, which will enable commensurate treatment to be applied to deﬁned beneﬁt superannuation interests, include the following:
...
- modiﬁcations to ensure that deﬁned beneﬁt contributions, which are a notional amount, are
  ...
  double counting of amounts that represent employer contributions

- rules for valuing deﬁned beneﬁt interests and certain other retirement phase interests

- adjustments to the TSB values for deﬁned beneﬁt interests subject to a family law payment split,

  where that interest is not able to be split between the member spouse and non-member spouse at

  the time of the payment split order or agreement

- changes to some of the method assumptions in ITR2021 schs 1A and 1AA which are used to

  value notional taxed contributions and deﬁned beneﬁt contributions, and

- extending the grandfathering provisions (ITR2021 reg 291-170.07) for pre-2009 notional taxed
...
*Refs: s 296-50(1)(, s 296-55(1)(, s 296-50, s 296-60(1)), s
296-310), s 307-230(3), s
307-230, s 293-145, s 995-1*

## Proportion of taxable superannuation

## An individual who receives a Division 296 tax assessment can choose to:

## Special rules apply for working out Division 296 tax for: