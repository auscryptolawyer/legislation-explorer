...
part: "12"
section: "cgt-roll-over-for-statutory-licences"
...
The roll-over applies when a statutory licence ends, CGT event C2 happens (¶11-270), and one or more new licences which authorise activity that is substantially similar to that authorised by the original licence, are issued for the original licence. Where there are multiple licences, all of the original licences must end as part of a single arrangement and the new licence or licences must be issued as part of that arrangement.
...
Partial roll-over Where a taxpayer receives non-licence capital proceeds (eg cash) in addition to a new licence, a partial roll- over is available. In that case, the roll-over applies only to the extent of the receipt of the new licence; any capital gain or loss arising from non-licence capital proceeds cannot be rolled over (s 124-150).

*Refs: s 124-140), s 124-145), s 124-155), s 124-160), s 124-165), s 124-150)*