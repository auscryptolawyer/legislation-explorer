...
part: "02"
section: "calculating-the-tax-of-minors"
...
- If the eligible taxable income does not exceed $416, the tax payable on that income is the greater
  ...
  the rates applicable to non-residents.
...
- If the eligible taxable income exceeds $416 but does not exceed $713, the tax payable on that
  ...
  taxable income, using in both cases the rates applicable to non-residents.

- Where the eligible taxable income exceeds $713, tax is payable on the whole of the eligible

  taxable income at the rate of 45%.