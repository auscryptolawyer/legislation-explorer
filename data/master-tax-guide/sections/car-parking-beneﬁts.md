...
(premises owned, leased or otherwise controlled) that are within one kilometre of a “commercial parking station” (s 136(1)). “Business premises” are premises which are used for the business operations of the employer. The employer does not need to have exclusive proprietary rights in respect of the business premises (Esso Australia 98 ATC 4953). For further guidance on the meaning of business premises, see TR 2000/4. See also ID 2001/255

- the commercial car parking station ordinarily charges members of the public more than the car

  parking threshold for all-day parking at the start of the FBT year. Where a parking station charges

  a fee for all-day parking which becomes progressively lower after a number of days parking, the

  lowest fee the parking station is taken to charge for all-day parking on a particular day is calculated

  by dividing the total fee payable for the period (eg for the year) by the “business days in the

  period” (s 39E; ID 2006/93). For the year ended 31 March 2025, the threshold was $10.77; the

  threshold for the year ending 31 March 2026 was not available at the time of publication (ATO

  website)

- the car is parked on those premises for a total period of more than 4 hours between 7.00 am and
...
- a car beneﬁt relating to the car is provided on that day to an employee or an associate in respect
  ...
  or the car is made available to the employee

- the provision of parking facilities for the car on that day is “in respect of” the employee’s

  employment (¶35-120). No car parking facilities are considered to have been provided where a car

  dealer provides a car from the car yard to employees for travel to or from work (TD 94/54)

- the employee has a “primary place of employment” on that day

- the car is parked at, or in the vicinity of, that primary place of employment. The word “vicinity” is

  a reference to places which are near, meaning in close spatial proximity to each other. Therefore,

  a car park which was approximately 2 km away from the employee’s primary place of employment
...
- the car is used on that day by the employee to travel between the employee’s place of residence
  ...
  and primary place of employment, and
...
- it has mechanisms to control who can enter and/or exit, or park at the facility, such as boom

  gates, or “pay and display” ticketing machines

- it charges more than a nominal fee for paid parking, for example charging for parking which is not
