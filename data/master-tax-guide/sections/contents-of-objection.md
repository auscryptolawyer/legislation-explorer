...
The objection should convey why the taxpayer considers the assessment to be incorrect and the reasons for that view (Lancey Shipping (1951) 9 ATD 267). The Commissioner will treat a request for amendment as an objection where there is: (1) any dispute over facts, issues or his interpretation of the law; (2) a challenge to an entitlement (other than against PAYG credits); or (3) a suggestion or request to preserve rights of review (PS LA 2008/19).
