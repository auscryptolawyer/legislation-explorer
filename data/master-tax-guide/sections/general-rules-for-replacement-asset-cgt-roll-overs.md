...
part: "12"
section: "general-rules-for-replacement-asset-cgt-roll-overs"
...
Where ownership of 2 or more assets ends If a taxpayer chooses for a replacement-asset roll-over to happen in relation to 2 or more assets at the same time, any capital gain or loss the taxpayer makes from each original asset is disregarded (s 124-15).
...
Mix of pre-CGT and post-CGT assets If the original assets are a mix of pre-CGT and post-CGT assets, a number of replacement assets are also taken to be pre-CGT assets. That number is the maximum possible that does not exceed: number of original pre-CGT assets number of replacement assets                         × total number of original assets If the result is less than one, none of the replacement assets are taken to be pre-CGT assets. The replacement assets that are not taken to be pre-CGT assets are taken to be post-CGT assets.

Example 2 Geraldine owns 100 shares in a company. The company cancels these shares and issues Geraldine with 10 shares in return. If 48 of Geraldine’s 100 original shares are pre-CGT assets, the number of replacement shares that are taken to be pre-CGT is 4 (ie 10 × (48/100) rounded down).
...
- Change of incorporation — Subdiv 124-I (¶12-390)

- Disposal of assets by a trust to a company — Subdiv 124-N (¶12-395)

- Exchange of stapled ownership interests for ownership interests in a unit trust — Subdiv 124-Q

  (¶12-440)

- Exchange of shares in a company or units in a unit trust for shares in another company pursuant

  to the business restructure roll-over — Div 615 (¶12-370).

This is achieved by treating the foreign interest holder as owning the roll-over interest, rather than the share sale facility which actually owns the interest (s 124-20).
