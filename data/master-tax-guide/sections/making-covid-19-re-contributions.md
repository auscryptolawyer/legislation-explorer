...
part: "13"
section: "making-covid-19-re-contributions"
...
A contribution made by an individual is covered by s 292-103 (and is a COVID-19 re-contribution) if:
...
- the amount of the contribution, or the sum of the amount of the contribution and previous

  contribution amounts if a previous contribution covered by s 292-103 has been made, is not more

  than the total of the COVID-19 early release amounts, and

- the individual makes a choice in the approved form (see below) for s 292-103 to apply to the

  contribution and gives the form to the superannuation provider in relation to the complying

  superannuation plan on or before the time when the contribution is made.

The “Notice of Re-contributions of COVID-19 early release amounts” approved form may be downloaded from the ATO website.

COVID-19 re-contributions are not tax-deductible An individual cannot claim a deduction for a COVID-19 re-contribution (ITAA97 s 290-169: ¶13-730).

*Refs: ITAA97 s 292-103, ITAA97 s 292-90(2)(, s 292-103, ITAA97 s 290-169*