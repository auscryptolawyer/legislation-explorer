...
part: "25"
section: "4-year-amendment-period"
...
- a taxpayer that carries on a business (or is a partner in a business) unless the taxpayer is a “small

  business entity” or “medium business entity” (¶7-050)
...
Small and medium business entities are generally entitled to a 2-year amendment period (¶25-310).
...
- Certain transactions between associates. This exclusion applies if the parties were not

  dealing at arm’s length; the transaction results in $200,000 or more being included in or allowable

  as a deduction from the assessable income of a party; or the transaction involves one or more

CGT events where capital proceeds total $200,000 or more. The exclusion would not apply to transactions that do not have income tax consequences, eg gifts between parties in a personal relationship.

- Distributions to entities connected with a private company. This excludes taxpayers involved

  in transactions to which Div 7A applies, where there is a mismatch between the company’s

  amendment period of at least 4 years and the related entity’s amendment period. The exclusion

  applies to related entities that are shareholders, former shareholders and their associates.

- Unpaid present entitlements. This excludes taxpayers involved in transactions where, as a

  result of Subdiv EA of Div 7A applying, certain amounts are included in assessable income as if
...
- Employee share scheme anti-avoidance rule. An anti-avoidance rule operates in respect of
  ...
  to this rule are excluded from the 2-year amendment period unless the company is a small or

  medium business entity that itself has a 2-year amendment period.

- Omitted income from foreign transactions. This exclusion applies to individual taxpayers who

  omit income from foreign transactions from their tax returns. However, this does not mean that

  taxpayers have to correctly identify income from foreign transactions at a correct label on the tax

  return (Elliott 2012 ATC ¶10-258; [2012] AATA 428).
...
- Releases from superannuation funds. Where an individual requests to have an amount
  ...
  released from their superannuation (under s 131-5 in sch 1 to TAA) relating to either an excess

  concessional contributions or excess non-concessional contributions determination, or a notice of
...
- R&D tax incentive. This exclusion applies if the taxpayer claims the R&D tax incentive (¶20-150)
  ...
  or certain related deductions, recoupments and adjustments.

- Certain roll-over relief. The exclusion applies if roll-over relief is claimed under ITAA97 Divs

125 (CGT demerger: ¶12-328), 126-B (certain inter-company CGT roll-overs: ¶12-490) and 615 (restructure roll-over: ¶12-370).

- Foreign resident entities disregarding capital gains or losses under ITAA97 s 855-10

  (¶12-720).

*Refs: s 131-5, ITAA97 s 855-10*