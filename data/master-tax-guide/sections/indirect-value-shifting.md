...
part: "12"
section: "indirect-value-shifting"
...
- apply not only to transfers or creations at less than their market value, but also to overvalue

  transfers

- have a consistent treatment of creation of rights depending on economic substance rather than

  legal form

- include de minimis exclusions
...
- the losing entity must be either a company or a trust (excluding certain superannuation entities),

  and

- the gaining entity can be any kind of entity, including an individual, but is usually a company or
...
- a wide range of transactions and dealings are excluded including:
...
## The key features of the rules indirect value shifting in Div 727 are that they:

## An indirect value shift will have consequences under these rules where:

## The scope of the indirect value shifting rules is limited because: