...
Where a scheme gives rise to an interest that will or may convert into an equity interest in a company, the life of the interest ends no later than the time when it converts. If it is uncertain whether or when the interest will convert, the possibility of conversion is to be disregarded (ITAA97 s 974-45).

*Refs: ITAA97 s
974-160), ITAA97 s 974-50, ITAA97 s 974-35), ITAA97 s 974-40), ITAA97 s 974-45)*