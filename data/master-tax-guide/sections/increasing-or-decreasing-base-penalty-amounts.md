...
part: "29"
section: "increasing-or-decreasing-base-penalty-amounts"
...
- the taxpayer takes steps to prevent or hinder the Commissioner from ﬁnding out about the false
  ...
  hindering might be failing to respond to inquiries (Leighton 2010 ATC ¶20-215; [2010] FCA 1086),

  unreasonable delay in responding to inquiries, failing to keep an appointment for interview without
...
- the taxpayer became aware of the false or misleading nature of a statement or the shortfall after

  the statement had been made and the taxpayer failed to tell the Commissioner or a relevant entity
...
- repeat oﬀence — the taxpayer had previously been liable for a penalty for lack of reasonable care,
  ...
  one of those bases. It is the mere repetition of the same conduct, rather than its repetition after the

  earlier imposition of a penalty, that warrants the uplift (Ross [2021] FCA 766), or

- the base penalty amount is payable because the taxpayer does not have a reasonably arguable

  case, or failed to provide a document to establish a tax liability on time, and was penalised for the
...
The base penalty amount may also be reduced for voluntary disclosure by taxpayers. Broadly (s 284-225):

- the penalty is reduced where a taxpayer voluntarily tells the Commissioner about a false or
...
- the base penalty amount is reduced by 20% in respect of a false or misleading statement,

  a shortfall or a scheme shortfall where, after being informed of an examination, the taxpayer
