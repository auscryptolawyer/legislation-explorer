...
part: "35"
section: "exemptions-from-fringe-beneﬁts-tax"
...
- relocation travel costs (including meals and accommodation en route) of the employee and
  ...
  family members (ss 58F; 61B; 143A; ID 2004/293). This can include “look-see trips”, ie trips for

  employees and their families to familiarise themselves with a new location after a transfer has

  been accepted but before the actual relocation (NTLG FBT Sub-committee meeting, 13 November
...
- the cost of leasing furniture for temporary accommodation (s 58E)

- the cost of connecting telephone, electricity or gas services to temporary accommodation (s 58D)

- necessary meal costs at a hotel, motel, etc (in excess of $2 per meal per adult or $1 per meal per

  child under 12) (s 61D)

- advances to cover such items as rental bond or electricity or gas deposits, provided the advance

  is repayable within one year (s 17)

- home sale and purchase costs (stamp duty, legal fees, estate agent’s commission) (s 58C),

  provided the employee sells the old dwelling within 2 years of the relocation

- the engagement of relocation consultants (s 58AA).
...
- have physical contact with (or are in close proximity to) customers or clients as part of their duties,
...
- Australian traineeship scheme — food and accommodation provided to trainees under the

  scheme (s 58S)

- compassionate travel — travel (including necessary accommodation and meals) by an
...
- live-in and non-live-in help — food and accommodation provided to a live-in domestic employee

  of a religious institution, priest or minister (s 58T) or to live-in help employed to care for the elderly
...
- long service awards — awards for long service of at least 15 years, provided the beneﬁt is no
  ...
  example, an employee was provided with an artwork valued at $1,200 in respect of 15 years of

  service. The employer was not able to claim an exemption for the artwork as its value exceeded

$1,000. After a further 5 years, the employee is provided with a watch valued at $600 in recognition of 20 years service. The watch is also not eligible for an exemption as its value exceeds $500 ((20 − 15) × $100), notwithstanding that the total exemption otherwise available for 20 years service is $1,500, the current award is less than that and no previous exemption has been claimed

- meals on working days — meals provided for consumption on working days to employees of
...
- membership fees and subscriptions — an employee’s subscription to a trade or professional
  ...
  journal, membership fees for a corporate credit card and membership fees for an airport lounge
...
- occupational health and counselling — work-related medical tests (including pre-employment
  ...
  services to former employees who were made redundant: TD 93/153), optical aids for screen-

  based equipment (ID 2004/557) and lifestyle and weight loss counselling (CR 2011/41) and migrant

  language training, but not massages (ID 2003/689) or the payment of employee health insurance

  premiums (Lake Fox Ltd 2012 ATC ¶10-248; [2012] AATA 265) (ss 58M; 143E). See generally CR

2007/81

- remote area housing — essentially accommodation not located in or adjacent to an eligible

  urban area (¶35-430)

- retraining and reskilling — employer-provided retraining or reskilling expenses where the

  employee has been made redundant (or will soon be made redundant). The exemption does not

  apply to retraining provided through a salary packaging arrangement, Commonwealth supported

  places at universities or provided by associates (s 58ZE)

- safety awards — awards genuinely related to occupational safety achievements (provided the

  value is $200 or less per recipient) (s 58R)

- student exchange programs — places provided in an approved student exchange program for

  an employee or an associate of the employee (s 58ZB)

- superannuation deposits — certain deposits made under the Small Superannuation Accounts

  Act 1995 (s 58W; ¶39-650)

- taxi travel — taxi travel (other than by limousine) provided by employers to employees for travel

  beginning or ending at the employee’s place of work or for sick employees for travel home or to

  any other place to which it is necessary or appropriate for the employee to go as a result of illness

  or injury (eg to a doctor or a relative) (s 58Z). “Taxi travel” has the same meaning as for GST

  purposes, namely “travel that involves transporting passengers by taxi or limousine, for fares” and

  includes taxis and ride-sourcing or ride-sharing services provided in a vehicle that is not licensed as
...
- travel for medical treatment — travel (including necessary accommodation and meals) by an
  ...
  employee or family member from a foreign country in order to obtain medical treatment at the least

  cost necessary (s 58L)

- vehicle parking — motor vehicle parking facilities in a limited number of circumstances (¶35-254)

- worker entitlement funds — contributions to funds set up to protect employee entitlements in

  the event of insolvency or to provide for entitlements such as redundancy and long service leave
...
- workers compensation — provision of workers compensation insurance coverage and provision
  ...
  of actual compensation for work-related injuries (s 58J; TD 93/64; CR 2005/103)
