...
part: "19"
section: "project-infrastructure-expenditure"
title: "Project infrastructure expenditure"
paragraph: "¶19-060"
---
...
- for site preparation costs for a depreciating asset (other than, for horticultural plants, expenditure

  in draining swamp or low-lying land, or expenditure in clearing land)

- for feasibility studies for the project (eg ID 2004/253, ID 2004/254)

- for environmental assessments for the project (eg ID 2004/582).

- incurred to obtain information associated with the project (eg ID 2004/253, ID 2004/583)

- incurred to obtain a right to intellectual property (¶17-015), or

- incurred for ornamental trees or shrubs.
