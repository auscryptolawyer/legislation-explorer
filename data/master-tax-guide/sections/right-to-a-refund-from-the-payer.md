...
part: "26"
section: "right-to-a-refund-from-the-payer"
...
- withheld the amount from a payment to the recipient (whether the amount has been paid to the
...
- paid the amount to the Commissioner in relation to an alienated personal services payment or a
  ...
  leave payment, the amount was not lawfully payable (TAA sch 1 s 18-65; PS LA 2011/11). For example,

  an investor may quote his/her TFN to an investment body but the body fails to record the number and later
