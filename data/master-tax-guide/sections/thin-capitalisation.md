...
- outward investing Australian entities where the sum of its average Australian assets and those

  of its associates represent 90% or more of the sum of its average total assets (including those of

  the associates) (s 820-37). This exempts Australian entities whose operations are substantially in

*Refs: s 820-46), s 820-35), s 820-37)*

- certain special purpose entities established for the purposes of managing some or all of the

  economic risk associated with assets, liabilities or investments where at least 50% of its assets are

  funded by debt interests and the entity is an insolvency remote special purpose entity (s 820-39).

Further, assets and “non-debt liabilities” that are wholly or principally private or domestic are excluded from the operation of Div 820 (s 820-32).
...
For inward investing ADIs (ie foreign ADIs with Australian permanent establishments), the minimum amount of equity capital is the lesser of:

- the safe harbour capital amount, ie 6% of Australian risk-weighted assets, and

- the arm’s length capital amount, ie a notional amount that represents what would reasonably be

  expected to have been the entity’s minimum arm’s length capital funding of its Australian business
...
- the safe harbour capital amount, ie 6% of the Australian risk-weighted assets

- the arm’s length capital amount, ie a notional amount that represents what would reasonably be

  expected to have been the bank’s minimum arm’s length capital funding of its Australian business

  throughout the year, and

- the worldwide capital amount. This allows an Australian ADI with foreign investments to fund its
...
- has chosen to apply the third party debt test, all or part of its debt deductions for the income year

  are disallowed (s 820-185(1A) and (2C)). The amount of debt deductions disallowed is the amount

  by which debt deductions exceed the entity’s “third party earnings limit” (s 820-427A)

- has not chosen to apply the third party debt test, and the entity’s “adjusted average debt” (s
...
- an outward investing entity (ADI) (ss 820-85(2BA) and 820-300(2)(c)(ii)).
  ...
  Provisional ATO guidance

The ATO has issued provisional guidance on the third party debt test for thin capitalisation purposes in Subdiv 820-AA (Draft TR 2024/D3) and updated its provisional compliance approach to restructures carried out in response to reforms to the thin capitalisation rules made by Act No 23 of 2024 (Draft PCG 2024/D3).

Draft TR 2024/D3 sets out the Commissioner’s views on the third party debt test, with a particular focus on the third party debt conditions in s 820-427A. Draft PCG 2024/D3 sets out the ATO’s compliance approach and risk assessment framework rating on the application of certain anti-avoidance provisions to restructuring in response to Act No 23 of 2024. Draft PCG 2024/D3 has been reissued with updates to include schs 3 and 4 — the thin capitalisation schedules. The draft Guideline was previously issued on 9 October 2024 to include schs 1 and 2 on the debt deduction creation rules (¶22-710). rules

*Refs: s 820-185(1, s 820-427, s
820-190(3)), s 820-190), s 820-200, s 820-217, s 820-220, s 820-85(1, s
820-85(3)), s 820-90), s 820-100), s 820-110, s 820-115, s 820-46), s 820-50), s 820-51), s 820-52), s 820-56), s
820-60), s 820-53), s 820-85(2*

## Australia

## ADI) for all of the income year and: