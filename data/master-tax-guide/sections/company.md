...
- if the asset is created as a result of CGT event D2, the expenditure incurred by the taxpayer in

  granting the option

- if the asset is created as a result of CGT event D3, the expenditure incurred by the taxpayer in

  granting the right, or

- if the asset is created as a result of CGT event F1, the expenditure incurred by the taxpayer on
