...
part: "11"
section: "partitions-of-co-owned-land"
...
- if the partition is by agreement between the parties, each transfer by a co-owner to the others is a
  ...
  supply. However, the mere fact that land held by co-owners is subdivided does not amount to a supply
...
- a partnership makes a supply to the partners in the course of its enterprise when it makes an in

  specie distribution of partnership land to them, or when it supplies an interest in the land by way of a

  partition (GST Ruling GSTR 2009/2).

## The ATO considers that a partition has the following GST implications: