...
GST on the actual amount received (¶21-060). th

- An input tax credit of 1/11 of the cost can be claimed on the purchase of a dairy quota. The
...
- As between the landowner and the sharefarmer, it would normally be desirable that both parties

  be registered, so that the GST on internal transactions can be cancelled out by input tax credit
