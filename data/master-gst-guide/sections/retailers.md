...
- The cash basis may be appropriate for businesses such as convenience stores and hot bread shops
  ...
  where the vast majority of sales are for cash, even though the normal requirements for using the cash

  basis are not satisfied (¶7-300).
...
- The retail sale of second-hand goods is subject to GST. There are special rules for determining
  ...
  entitlement to input tax credits, and for allocating GST and input tax credits on a global basis (¶16-100).
