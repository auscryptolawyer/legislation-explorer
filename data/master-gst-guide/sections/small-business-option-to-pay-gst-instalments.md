...
part: "08"
section: "small-business-option-to-pay-gst-instalments"
...
from its third quarter. As it has lodged returns for tax periods totalling 6 months (ie less than 7 months), it takes into account the 3 months preceding the third quarter (ending 31 March), ie December quarter. On this basis, it is in a net refund position (ie $12,000), so it cannot elect to adopt the instalment system at this time.
...
The election must normally be made by 28 October of the relevant financial year (s 162-25), ie before the due date for lodgment and payment of the first quarterly GST remittance. However, in certain situations part- year elections may be made, for example where a taxpayer first becomes eligible to use the instalments system after 28 October, and their current lodgment record does not exceed 6 months. This typically occurs where a newly registered GST taxpayer has not yet lodged more than 2 quarterly GST returns. In these circumstances, the election must be made by the date the taxpayer would otherwise have had to lodge a GST return for the tax period in which they became eligible (illustrated in the above example). The election then applies from that tax period.
...
Effect of making GST instalments election
...
- must pay the GST for that instalment tax period by quarterly instalments (see below)

- must lodge a BAS for that instalment tax period (see below). Taxpayers can opt not to lodge the BAS

  for an instalment period if they only report GST and Pay As You Go (PAYG) and accept the instalment

  amounts calculated by the Commissioner. See ATO Instalment notices for GST and PAYG instalments
...
The annual GST amount is calculated in the annual return. Any difference (between this and the amounts already paid) must (for a shortfall) be paid by the time for lodgment of that return (ss 162-105, 162-110). If there has been an overpayment, this will be refunded (s 35-5).

If the taxpayer has died, ceased to carry on an enterprise or has its registration cancelled during the instalment tax period, the obligation to lodge an annual return for that period remains (s 162-85). However, there is no requirement to pay instalments for any quarter that starts after the death, etc.

Illustration: Death of GST instalment payer Jan is a GST instalment payer. She dies on 15 January. A GST annual return must be lodged by the due date for the income tax return for the financial year in which she died is due. The last quarterly GST instalment for Jan will be for the quarter ending 31 March, ie the quarter in which she died.

If the taxpayer becomes incapacitated (eg becomes bankrupt, goes into liquidation or receivership) or otherwise ceases to exist, the instalment tax period ends on the day before that happens, and the return st must be lodged by the 21 day of the following month (s 162-90) together with any outstanding GST.

Illustration: Incapacity of GST instalment payer Continuing the above illustration, assume that Jan becomes bankrupt instead of dying. An annual return must be lodged by 21 February.

If the membership of a GST group changes, the instalment tax period ends at that time (s 162-95). The st representative member must lodge the annual return by the 21 day of the following month, together with any outstanding GST.

Illustration: GST instalment payer leaves GST group A, B and C are members of a GST group and commence paying by instalments from 1 July. In December, C leaves the group. The GST group must lodge the annual return by 21 January. All parties will revert to ordinary quarterly tax periods and, in accordance with the normal rules, cannot resume paying by instalments until they have current lodgment records of at least 4 months.
...
For the December quarter, Enterprises revises its annual GST estimate to $164,000. The varied second instalment is $42,000 (1/2 × $164,000 − $40,000).

For the March quarter, Enterprises does not change its estimate. The third instalment is $41,000 (3/4 × $164,000 − $82,000).
...
- the estimated annual GST amount relating to any quarter is less than 85% of the actual annual GST

  liability (s 162-180), or

- each varied instalment is not a correct proportion of the estimated annual GST amount (s 162-185).

This discourages, for example, an entity that correctly estimates its annual GST amount from varying its instalments to zero for the first 3 quarters and then paying 100% of the estimated annual liability in the final quarter.
...
The concession allows such taxpayer to only pay 2 GST instalments, due on 28 April and 28 July (s 162-80) for any financial year.

*Refs: s 162-50), s 162-55), s 162-60), s 388-55), s 162-105, s 35-5), s 162-85), s 162-90), s 162-95), s
162-140), s 162-175), s 162-180), s 162-185), s 162-190, s 25-5), s 162-80)*

- carries on a primary production business in the year in which they elect to use the instalment system,
...
The concession effectively defers the first 2 instalments until the net annual GST amount is paid. Although this concession can provide cash flow relief, such taxpayers likely to be in net payable position should take care to manage their cash flow (¶21-070).

## GST instalments

## Making the election means that the taxpayer:

## The concession applies if a taxpayer: