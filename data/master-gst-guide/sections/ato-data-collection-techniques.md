...
part: "18"
section: "ato-data-collection-techniques"
...
Tip-offs and media reports.

Random sampling to assess the level of risk on particular areas. For example, this has revealed high non- compliance on capital asset disposals (¶4-090).

Illustration: ATO data collection In order to identify compliance risks in the scrap metal industry, the ATO Scrap Metal Compliance Program analysed information made available through:
...
- the analysis of over 400,000 individual transactions between dealers and suppliers.

## Industries covered include:

## Third party data matching from bodies such as: