...
- specified categories of second-hand goods are acquired from registered or unregistered suppliers,

  and the dealer exercises the option to apply the global method.

To apply the global accounting rules, the dealer must hold records including the name and address of the supplier, a description of the second-hand goods (including their quantity), the date and the price (s 66-55).

The Commissioner can issue determinations modifying the effect of these rules, for example, determining that certain acquisitions are — or are not — covered (s 66-70).

Goods divided for separate supplies Some dealers in second-hand goods buy goods in single aggregated lots and then disaggregate them for separate sale. For example, a car wrecker might buy a car then break it down into parts for sale; or a dealer may buy the whole contents of the house of a deceased estate, then sell them individually.
...
- the consideration for the acquisition is more than $300. For purchases up to $300 an ITC can be

  claimed immediately. The issue of tracing does not arise. A second hand dealer may, however, choose

  to apply the global method to these smaller sales, as for example to may be more convenient to treat

  all sales in the same way

- bearing in mind the nature of the goods and the way in which they are supplied, it would be

  reasonable to expect them to be divided before supplying them in 2 or more separate supplies, and

- the goods are not sold in a single supply (s 66-40(1)).

*Refs: s 66-55), s 66-70), s 66-65), s 66-45, s 66-60), s 66-40(1))*

- the sale to the dealer was a taxable supply (in this case, the normal rules for credits apply)

- the sale to the dealer was GST-free (eg from a charity)

- the goods were hired

- the dealer imported the goods

- the dealer disposed of the goods in a way that does not attract GST, for example, they were given

  away or disposed of outside the business

- the goods purchased were separately itemised and sold as such (s 66-40(2)).

Illustrations: When the global method for separate supplies of second hand goods A dealer buys a single lot of antiques comprising various items for $2,000 from a deceased estate and later puts them up for sale as separate items — the global method applies.

A dealer buys an individual antique from a private individual for $2,000 — the global method does not apply.
...
- the dealer has claimed or intends to claim an ITC for the acquisition under some other provision
...
Illustration: Using global accounting method for eligible second hand goods A registered dealer buys second-hand books from both registered and unregistered persons in Australia and also imports a readily distinguishable category of second-hand books. Although all the books may be eligible, the dealer opts only to pool the Australian th purchases. This means that 1/11 of the consideration for those books will be added to the pool, whereas the GST paid on the imports can be claimed in the tax period of importation.

See also ¶34-260.

## The global accounting method may apply where:

## The separate supply rule does not apply if:

## The option is not available where: