...
- Trade-ins are treated as both a supply by the purchaser and a separate supply by the seller
...
- GST applies to repairs, parking and fuel (¶12-170), but not to non-taxable charges such as motor
  ...
  vehicle registration or fines. Special considerations may apply to vehicle modification permits (¶4-080).
...
- The cash basis of accounting may be more appropriate than the accruals basis where labour is the
  ...
  vehicles is only for the purpose of providing lessons (¶7-300).