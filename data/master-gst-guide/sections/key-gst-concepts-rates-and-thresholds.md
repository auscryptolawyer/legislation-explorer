...
part: "25"
section: "key-gst-concepts-rates-and-thresholds"
...
Compulsory registration. Registration is compulsory for businesses with GST turnover of $75,000 or more ($150,000 for non-profit bodies) (¶3-030).
...
Luxury car tax threshold. An annually indexed threshold above which luxury car tax (¶23-150) is required to be remitted by the vendor of the car. See also Car limit.

Simplified accounting methods for food retailers. These methods can normally only be used if the relevant turnover is less than $2 million (¶13-215).

Small business entities. The aggregated turnover must be less than $10 million (or $50 million in certain limited cases).

Tax invoices and adjustment notes. There is no obligation to issue a tax invoice if the value of the supply does not exceed $75. There is no obligation to issue an adjustment note if the amount of the adjustment does not exceed $75 (¶5-170; ¶6-135).