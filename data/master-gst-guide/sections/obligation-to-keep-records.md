...
- that give rise to transitional input tax credits (ITCs)

- liable for wine equalisation tax, or

- taxable supplies or importations of luxury cars (Administration Act Sch 1 s 382-5).

In each case, the records must record and explain all transactions and other relevant acts. The records must:
...
Records may be kept electronically. This includes encrypted records, e-commerce records and records stored in the cloud. For ATO requirements on security and accessibility, see Taxation Ruling TR 2008/2.

Records must be kept for 5 years from when the relevant transaction or act has been completed. This period is extended if:
...
Where a case involves serious non-compliance such as falsifying records and fraud, or where the imposition of administrative penalties has been ineffective, the ATO may consider referring the matter for prosecution by the Director of Public Prosecutions. This action, presumably, could be taken under Administration Act Sch 1 s 382-5, which prescribes a maximum penalty of 30 penalty units, or — where the records that are kept are incorrect — under the general provisions relating to tax records, which allow for far more severe penalties, including imprisonment (Administration Act ss 8L, 8Q, 8T).

Checklist: Record keeping

*Refs: s 382-5), s 288-25, s 384-12), s 384-12, s 382-5*
...
- notification has been received from the Commissioner that retention of the records is not required, or
...
Notwithstanding the absence of records due to loss in a disaster, a taxpayer still bears the onus of proving that the Commissioner's assessments are excessive. In Raschta Coatings Pty Ltd as trustee for the Raschta Coatings Trust v FC of T [2015] AATA 34 the taxpayer was successful in establishing that assessments issued by the Commissioner following an audit were excessive despite the absence of records which were claimed had been lost in the 2010–11 Brisbane floods. The taxpayer was able to show that various amounts credited to its bank account were not the proceeds of taxable supplies, but were either loans, intercompany transfers, repayments of loans or other non-taxable deposits.

## Records must be kept for the following transactions:

## The following records should be retained:

## Records are not required to be retained if: