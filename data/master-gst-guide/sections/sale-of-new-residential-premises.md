...
However, if the premises were used for residential accommodation before 2 December 1998 the sale will be input taxed. For this exception to apply, the premises must also have been within the definition of residential premises (¶11-010) at that time (Marana Holdings Pty Ltd & Anor v FC of T 2004 ATC 5068; [2004] FCAFC 307). Use of premises as commercial residential premises (¶11-030) is not treated as use for residential accommodation (GST Determination GSTD 2012/11).
...
- if land with a building that has previously been sold as residential premises is subdivided, so that
  ...
  taxable on sale. A house built on the new vacant block would be treated as new.

- if the land on which a building that has previously been sold is increased in size, and then sold, the

  original house and land package would not be new residential premises and may be input taxed. To the

  extent that the sale relates to the additional land, it may be taxable.
...
- where a residential building is relocated from one block of land to a different vacant block, the building
  ...
  building is relocated to a different part of its original allotment, which is reduced in size, the house and
...
- the renovations need to affect the building as a whole, although an individual strata unit or apartment
  ...
  is treated as a building in itself, to be considered substantial. For example, a building is not treated as

  being substantially renovated if there are radical changes to only one or two rooms and only minor work

  done on the remainder. However, there would be a substantial renovation where, for example, the fibro

  exterior of a house was replaced by brick; some interior walls were removed; flooring throughout the

  house was completely replaced by polished hardwood floors; the existing kitchen and bathroom was

  removed and a new extended kitchen and bathroom (with addition of a spa bath) was installed
...
A developer demolishes some existing residences and replaces them with a new one. This will be treated as new residential premises, even though there were previously residences on the land, and GST will apply on its sale. The same would apply if the developer substantially rebuilt the existing premises.

Residential premises in a CBD are converted for commercial use. A developer later buys the building, demolishes the building and rebuilds an apartment block. This will be treated as new residential premises, even though there was previously a residence on the land, and GST will apply on its sale.

A Housing Authority sells a house that it has held for use as public housing since 1997 but which had not previously been sold. As the premises were used for residential accommodation before 2 December 1998, the sale is input taxed.

A developer constructs a block of apartments, which it uses for short-term rentals for a period of six years. It then sells them. This sales are input taxed and is not subject to GST.

A taxpayer constructed a motel in 1997. In 2021, it strata titles one of the units and sells it as residential premises. This is treated as the sale of new residential premises and subject to GST. The use of the unit as [part of] commercial residential premises before 2 December 1998 is not treated as use for residential accommodation before 2 December 1998. (Based on Interpretative Decision ID 2008/136.) New residential premises are excluded from the rule that a supply will be treated as input taxed if it is a supply of anything that has been used solely in connection with other input taxed supplies made by the taxpayer (¶1-170).

Illustrations: New residential premises do not become input taxed when used for residential rent A property developer constructs and sells a new dwelling. The developer lets the dwelling during the period between exchange of contracts and settlement. As the letting of the dwelling is an input taxed supply (¶11-310), s 9-30(4) would normally have the effect that the sale would also be input taxed. However, this will not apply as new residential premises are excluded from that rule. The sale will be subject to GST.

As part of its development business, a property developer demolishes and removes a house that it had used previously leased. It then sells the vacant land. This sale would be taxable. The input taxing rule in s 9-30(4) does not apply — although the land was not exempted as new residential premises, the demolition was connected with the property development business, not the previous input taxed leasing. The position may be different if the destruction of the house had been as a result of a fire, unconnected with the property development business (based on Interpretative Decisions ID 2009/18; ID 2009/19; ID 2009/40).
...
Supplies within groups New residential premises do not cease to be new residential premises the sale of which is subject to GST by being supplied within a GST group or between joint venture partners (s 40-75(2A)). This measure is directed at artificial arrangements designed to exploit the group or joint venture rules, though it is arguable whether such arrangements would have been effective, either being prone to the application of the anti-avoidance rules, or rendered ineffective on other grounds.

Previous sale as commercial residential premises Premises can still be treated as new residential premises even though they have previously been sold as commercial residential premises (¶11-030). For example, if a motel is sold, then strata titled, the subsequent sale of the individual units could be treated as a sale of new residential premises (Interpretative Decision ID 2008/136).

Time of supply Under most standard form contracts for the sale and purchase of land the supply does not occur until settlement (¶11-000). See ¶11-065 for the attribution rules applying to taxable sales.

Adjustment where sale deferred A GST adjustment may be necessary where there is a delay in selling the units in a property development, and they are rented out pending sale (¶6-300).

*Refs: s 40-65), s 195-1), s 40-75), s 9-30(4), s 40-75(2*