...
To be eligible, each member of the group must be registered, be endorsed as a tax-exempt charity, be part of the same religious organisation and not be a member of any other GST religious group (s 49-10). The application must nominate a principal member who accounts for changes to group membership and status (s 49-5). However, each member is liable to lodge its own GST return for its own external transactions.

*Refs: s 49-30, s 49-10), s
49-5)*