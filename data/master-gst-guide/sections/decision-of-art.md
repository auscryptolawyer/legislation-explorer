...
The ART has the power to remit an assessment to the Commissioner with a direction that the assessment be amended by substituting the amount which the ART determines (Stevenson v FC of T 91 ATC 4476). The ART does not, however, have the power to remit a matter to the Commissioner in circumstances where, in order to give effect to the ART’s findings, an entirely new assessment would need to be made (Case 50/93, 93 ATC 534).