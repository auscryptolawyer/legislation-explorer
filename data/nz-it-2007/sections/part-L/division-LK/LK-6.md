...
section: LK-6
section_title: Use of credits by group companies
compilation_no: 935
...
- (b) a credit of company A for a tax loss component of the loss company:

- (c) the use of the credit to satisfy an income tax liability for the use of a tax loss component to reduce net income, in both subpart IC and section GB 4 (Arrangements for grouping tax losses: companies):

- (d) company C for the company B:

- (e) the income tax liability of company C for the net income of company B:

- (f) sections LK 1 to LK 5 for sections IA 3 to IA 5 (which relate to the use of tax losses generally).
