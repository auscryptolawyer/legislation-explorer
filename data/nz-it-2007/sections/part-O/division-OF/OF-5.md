...
section: OF-5
section_title: ASCA transfer to imputation credit account
compilation_no: 935
...
- (b) an imputation credit under section OB 18 (ICA transfer from ASC account) for the amount calculated under subsection (4).
...
- (b) the day before the company stops being an ICA company if the election is made on the occasion of cessation.
