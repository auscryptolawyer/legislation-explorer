...
- (b) sections FM 34(2) (Nominated companies):
...
- (g) section LB 2 (Tax credits for provisional tax payments):

- (h) section RA 9 (Treatment of amounts withheld as received):

- (i) sections RE 4, RE 5, and RE 7 to RE 9 (which relate to requirements for agents or trustees to pay RWT):

- (j) section RE 22 (When payment treated as non-resident passive income):

- (k) section RF 4 (Non-resident passive income received by agents and others):

- (l) section YA 1 (Definitions), the definition of offered or entered into in New Zealand.
