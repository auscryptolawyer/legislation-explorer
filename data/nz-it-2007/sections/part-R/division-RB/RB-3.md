...
division: RB
division_title: Subpart RB—Terminal tax
section: RB-3
...
**(4)**  If the taxpayer derives a dividend to which subsection (2) applies, they do not have a credit under section LE 1 (Tax credits for imputation credits) for an imputation credit attached to the dividend.
