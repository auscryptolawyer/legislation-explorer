...
division: YE
division_title: Subpart YE—References to balance dates and years
section: YE-1
section_title: References to balance dates and years
compilation_no: 935
...
**(3)**  A reference to an income year that is identified by a reference, in full or short form, to 2 years is a reference to the corresponding income year for the tax year that a reference to the same 2 years would identify.

**Standard balance date or accounting years**

**(4)**  A reference to a person with a standard balance date, a standard accounting year, or a standard income year is a reference to a person who files a return of income under section 33 of the Tax Administration Act 1994 for a tax year on the basis of a corresponding income year also ending on 31 March.
