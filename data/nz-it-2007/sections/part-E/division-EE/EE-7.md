...
section: EE-7
section_title: What is not depreciable property?
compilation_no: 935
...
- (fc) a utilities distribution network, to the extent to which it is treated as an item of property separate from the relevant utilities distribution assets:
