...
section: DB-5
section_title: Transaction costs: borrowing money for use as capital
compilation_no: 935
...
**(1B)**  Subpart DG (Expenditure related to use of certain assets) overrides this section for expenditure to which that subpart relates.
