...
section: DV-5
section_title: Investment funds: transfer of expenditure to master funds
compilation_no: 935
...
- (b) the member fund may transfer expenditure only to the extent to which it has a tax loss in the corresponding tax year, with the tax loss calculated as if this section did not exist; and
...
- (b) the member fund must treat the expenditure as a loss balance.
