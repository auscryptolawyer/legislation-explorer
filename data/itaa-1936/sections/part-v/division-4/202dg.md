...
<a id="s202DG-2"></a>
**(2)** Where more than 2 persons are jointly entitled to the property or rights that constitute an investment to which this Part applies, all of Tax file numbers Part VA Quotation of tax file numbers in connection with certain investments Division 4 Section 202DH the persons are to be taken to have quoted their tax file numbers in connection with the investment if and only if:
