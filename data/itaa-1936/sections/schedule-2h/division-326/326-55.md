...
> <a id="s326-55-1-f"></a>
> **(f)**  shares (ordinary shares) of only one class in the entity are, within the limitation period, issued to the trustee to hold on behalf of existing members in exchange for the membership rights referred to in paragraph (a) and, in accordance with the choice of each existing member, to transfer to the member
