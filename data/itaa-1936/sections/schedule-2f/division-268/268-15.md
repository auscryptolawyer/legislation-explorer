...
> <a id="s268-15-3-c"></a>
> **(c)**  the earliest time in the period when a group begins to control a non-fixed trust (other than an excepted trust) that holds directly or indirectly a fixed entitlement to a share of the
