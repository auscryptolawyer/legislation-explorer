...
> <a id="s57-25-1-b"></a>
> **(b)**  a CGT event that happens after the transition time in relation to an asset owned by the transition taxpayer; where the transition taxpayer owned the asset at all times from the transition time until the disposal or the CGT event.
...
<a id="s57-25-6"></a>
**(6)**  The provisions are listed in the table below. Provisions of the Income Tax Assessment Act 1997 are identified in normal text. The
...
<a id="s57-25-7"></a>
**(7)**  To avoid doubt, an effect of subsection (2) is that the sum of all allowable deductions (if any) in respect of the writing off as bad of
