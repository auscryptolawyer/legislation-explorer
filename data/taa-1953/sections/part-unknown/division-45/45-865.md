...
> <a id="s45-865-2-a"></a>
> **(a)**  the sum of so much of each instalment payable by the entity (even if it has not paid it) for an *instalment quarter of a *consolidation transitional year for the entity, or for that year, as is reasonably attributable to so much of that quarter or year: Authorised Version C2026C00170 registered 28/04/2026 Part 2-10 Pay as you go (PAYG) instalments Section 45-865
