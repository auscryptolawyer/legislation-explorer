...
<a id="s12-145-4"></a>
**(4)**  If that entity withholds an amount from that share as required by subsection (2), subsection 12-140(2) does not require an amount to be withheld from a payment of all or part of that share to the *investor. Authorised Version C2026C00170 registered 28/04/2026 Part 2-5 Pay as you go (PAYG) withholding Section 12-150
