...
<a id="s12A-10-1"></a>
**(1)**  If the entity that receives a payment as mentioned in subsection 12-215(1), 12-250(1) or 12-285(1) is the trustee of an Authorised Version C2026C00170 registered 28/04/2026 Part 2-5 Pay as you go (PAYG) withholding Section 12A-15 *AMIT, the entity need not withhold an amount under that subsection from the payment if the payment arises because of the operation of section 12A-205 (deemed payments).
