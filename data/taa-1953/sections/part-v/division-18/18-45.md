...
> <a id="s18-45-2-b"></a>
> **(b)**  if paragraph (1)(b) applies—each of the entities mentioned in that paragraph is entitled to a credit of an amount worked out using the formula: 1 The penalty amount ´ Number of those entities 
