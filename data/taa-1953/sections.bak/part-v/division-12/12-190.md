...
> <a id="s12-190-4-b"></a>
> **(b)**  the payment (disregarding so much of it as relates to *GST payable on the *supply) or, if the payer has also made, or proposes to make, one or more other payments to the other entity for the supply, the total of all the payments (disregarding so much of them as relates to *GST payable on the supply) does not exceed $50 or such higher amount as is 
*For definition, see section 995-1 of the Income Tax Assessment Act 1997.
