...
<a id="s54-40-1"></a>
**(1)**  If an entity (the parent entity) has a [*GST branch*](/gst-1999/s195-1#s195-1-gst-branch), Division 17 applies to the parent entity as if it had an additional *net amount, relating to the branch, for each tax period.
<a id="s54-40-2"></a>
