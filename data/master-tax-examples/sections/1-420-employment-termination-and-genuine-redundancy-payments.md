...
part: "1"
section: "1-420-employment-termination-and-genuine-redundancy-payments"
...
Solution Employment and other payments on termination of employment are dealt with in ITAA97 Divs 82 and 83.

The relevant factors include:

- lump sum payments received in consequence of termination of employment may attract concessional

  tax treatment as employment termination payments (ETPs) (s 82-130)

- some kinds of lump sum payments on termination of employment do not qualify as ETPs (s 82-135)

- lump sum annual and long service leave payments are taxed separately (ITAA97 Subdiv 83-A and 83-

  B)

- genuine redundancy payments and early retirement scheme payments also attract concessional tax

  treatment (ITAA97 Subdiv 83-C), and

- the tax-free component of an employment termination payment includes the pre-July 83 segment of

  the payment (s 82-140).
...
- it is not a payment mentioned in s 82-135 (s 82-135 refers to payments such as superannuation

  benefits, unused annual and long service leave payments and the tax-free part of a genuine
...
- the employee must be dismissed before reaching the pension age (67 years for a person born on or
...
*Refs: s 82-130), s 82-135), s 82-140), s 82-135, s 83-10(2), s 83-175(1)), s 83-175(2)), s 83-170), s 82-130*