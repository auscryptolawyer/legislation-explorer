...
part: "10"
section: "10-360-commercial-debt-forgiveness"
...
Patrice was a self-made millionaire, with a wide portfolio of investment properties across Sydney and the Gold Coast.

Alpha Pty Ltd was intending to market a range of environmentally friendly skin treatments for men, but Alpha struggled to gain a foothold in the crowded marketplace and made significant trading losses in each of the subsequent trading years. Nevertheless, Alpha initially stuck with its original repayment plan, and, by 30 June 2023, the balance of the debt owed to Patrice had reduced to $1.75 million. From that point on, repayments became far more sporadic and eventually stopped altogether at the end of December 2024, with the balance of the loan standing at $1.7 million.

On 30 May 2025, Francois wrote to Patrice, on behalf of Alpha Pty Ltd, advising him that the company would be unable to repay the balance of the loan. Recognising that the company was in financial trouble and that forcing the company to repay the loan would force it into insolvency, Patrice agreed to write off the loan. On 1 July 2024, Alpha Pty Ltd had brought forward trading losses of $3 million.

What are the tax consequences of the loan write-off for Patrice and Alpha Pty Ltd?

Solution The lender (Patrice) Where a taxpayer has lent money and the debt is later written-off as bad, there are 3 possible tax outcomes that may arise in respect of the loss that has been suffered.
...
Therefore, Patrice may be entitled to a claim a capital loss in respect of the unpaid portion of the debt. This will arise because of the operation of CGT event C2, to the extent that the taxpayer is due a debt and does not recover it, and releases or discharges the obligation or accepts a lesser amount in full settlement.

The time at which the capital loss is likely to arise would typically be at the time that a contract or similar deed is made to acknowledge that the debt is formally discharged or released, in this case around 30 May 2025. The amount of the capital loss will be calculated by reference to the proceeds received back from the borrower (if any) less the reduced cost base of the loan receivable ($1,700,000).

The borrower (Alpha Pty Ltd) The commercial debt forgiveness rules apply where a creditor forgives a commercial debt owing by a debtor (ITAA97 ss 245-1 to 245-265).

A commercial debt is defined as a debt on which interest is paid (or, if none is paid, had it been payable) would be an allowable deduction to the debtor. If the debt is interest free, the test is applied on the assumption that interest is paid or payable.

This is a commercial debt as Alpha Pty Ltd would be able to claim (and possibly has claimed) interest incurred on the loan over the period since the loan was made.
...
- calculate the value of the debt (ITAA97 s 245-55)

- calculate what (if any) consideration was given for the forgiveness (ITAA97 s 245-65).

- subtract the consideration from the value of the debt to arrive at the gross forgiven amount. If the

  value of the debt is equal to or less than the consideration, Div 245 will not apply (ITAA97 s 245-75),
...
- firstly, reduce deductible revenue losses of the debtor that otherwise could be claimed as a deduction
  ...
  in the forgiveness year or a later year of income

- secondly, reduce net capital losses incurred by the debtor in respect of the year before the

  forgiveness year

- thirdly, reduce undeducted revenue or capital expenditure (eg the adjusted value of a depreciating

  asset) of the debtor that would otherwise be deductible in the forgiveness year or a later year, and

- lastly, reduce the cost bases of assets of the debtor at the beginning of the forgiveness year.

Within each of the above 4 classes of deductible amounts, the debtor can choose the relevant loss, item of expenditure or asset against which the net forgiven amount is to be applied, but the net forgiven amount must be applied to the maximum extent possible within each class.

Any part of the net forgiven amount which remains after being applied against all available deductible amounts is disregarded, except where the debtor is a partnership, in which case the residual amount is applied against the reducible amounts of the partners (ITAA97 ss 245-195, 245-215).
