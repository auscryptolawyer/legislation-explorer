...
part: "2"
section: "2-110-relationship-breakdown-roll-over-relief"
...
Solution If personal assets are transferred due to a marriage breakdown, automatic CGT roll-over relief will be available under Subdiv 126-A where certain conditions are met. Where CGT roll-over applies, any capital gain or loss made by the transferor spouse (or entity) on the transfer of the asset is disregarded and, assuming the asset is a post-CGT asset, its cost base to the transferor spouse becomes the cost base of the transferee spouse (s 126-5(5)). The practical effect of this is that the CGT consequences are deferred until the transferee spouse ultimately disposes of the asset. If the conditions for roll-over relief are not met, the transfer will be considered to be a normal disposal and acquisition and the usual CGT rules will apply.

The conditions for obtaining CGT marriage breakdown roll-over relief are:

- an asset is disposed of by a person to their spouse or former spouse, and

- the disposal is under a qualifying legal instrument:

1. an order of a court under the Family Law Act 1975 (FLA) or a corresponding foreign law, including consent orders (Taxation Determination TD 1999/47) 2. a binding financial agreement under the FLA or a corresponding written agreement that is binding because of a corresponding foreign law 3. an arbitral award under the FLA or a corresponding arbitral award under a corresponding state, territory or foreign law, or 4. a written agreement made under a state, territory or foreign law relating to relationship breakdowns where the agreement is equivalent to a binding financial agreement under the FLA (ITAA 97 s 126-5).

The roll-over applies only if, at the time of the disposal:

- the spouses or former spouses are separated, with no reasonable likelihood of cohabitation being

  resumed, and

- the disposal happened because of reasons directly connected with the breakdown of the relationship

  (ITAA 97 s 126-25).

The roll-over also applies to de facto relationships (including same-sex partner relationships).

A CGT roll-over may also apply where the asset is transferred by a company or trust, instead of directly by a spouse (ss 126-15, 126-20). Crucially, the CGT roll-over only applies in relation to assets transferred from a spouse, company or trust to the other spouse. Where the asset is transferred to an entity (eg a company or trust) other than a spouse, the roll-over relief is not available. On the face of it, therefore, Geoffrey is not entitled to apply roll-over relief to the transfer of his shares.
...
The trust controlled by Judith will be deemed to have acquired the shares for their market value at the date of transfer.

There are no tax implications arising from the transfer for Judith personally.

*Refs: s 126-5(5)), s 126-5), s 126-25), s 126-15, s 126-5(2)), s 104-10(2)*