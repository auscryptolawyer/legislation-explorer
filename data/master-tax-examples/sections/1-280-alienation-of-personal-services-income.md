...
part: "1"
section: "1-280-alienation-of-personal-services-income"
...
- fees from RN for engineering services — $180,000

- wages paid to Robert for working part-time as a draftsman — $25,000

- salary paid to Robert by REPL — $50,000

- salary paid to Vivien by REPL for accounting and secretarial services — $30,000

- car expenses (after reducing for personal use) — $6,000, and

- superannuation contributions made by REPL on behalf of both Robert and Vivien — $30,000

  ($15,000 each).

Advise Robert as to his income tax position for 2024–25 and how he should manage his affairs in order to avoid the operation of the personal services income (PSI) regime in future years.
...
- $15,000 — superannuation contributions made by REPL on behalf of Robert
...
- the 80% rule and any of the PSB tests (unrelated clients, employment or business premises test) are
  ...
  satisfied (s 87-15), or

- a PSB determination is obtained from the Commissioner (s 87-60).

  (See Taxation Ruling TR 2022/3.)

Results test Robert could satisfy the 3 conditions of the results test if:

- in relation to at least 75% of his PSI during the year the income is for producing a result

- he supplies his own equipment and any other necessary plant and equipment, and

- he is or would be liable for the cost of rectifying any defects in the work performed.

Note that an ordinary passenger motor vehicle, although a substantial asset, will not satisfy the requirement in the results test to supply plant and equipment or tools of trade. Vehicles potentially meeting this requirement include commercial vehicles or those specifically adapted or purpose built for the relevant work (TR 2001/7 para 88). 80% rule Robert could satisfy the 80% rule if less than 80% of the PSI is from one source and he satisfies any of the following tests:
...
The unrelated client test would require Robert to make offers or invitations for his professional services to the public and provide those services to 2 or more unrelated clients (s 87-20).

The employment test would require that Robert ensure that at least 20% of the market value of his work is performed by entities that are not his associates. The test could be met by employing unrelated persons to provide engineering services but would not be met by engaging a spouse or other family member to do non- principal work such as bookkeeping and secretarial services (s 87-25; example 27 in TR 2022/3).

The business premises test could be satisfied if Robert owned or leased premises for the conduct of his business that are physically separate from premises used for private purposes (s 87-30).

PSB determination In some cases, the Commissioner may make a PSB determination if satisfied that, although the entity did not meet one of the PSB tests during the year, this was only because of unusual circumstances applying to the entity in that year. To make the determination, the Commissioner must be satisfied that the conditions in one or more of s 87-60(3A), (3B), (5) and (6) are met (s 87-65(3)).

To avoid the operation of the PSI regime in 2025–26, Robert would be advised to ensure that the contract with RN included the 3 conditions to satisfy the results test. In addition, he should consider structuring his business or operations so as to satisfy one or more of the 80% rule tests.

*Refs: s 84-5), s 86-15(1)), s 86-15(2)), s 86-15(3)), s 85-20), s 85-25), s 87-18), s 87-15), s 87-60), s 87-20), s 87-25, s 87-30), s 87-60(3, s 87-65(3))*