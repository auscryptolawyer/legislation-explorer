...
part: "1"
section: "1-320-derivation-agreement-for-right-to-use-proprietary-software-and-related-ser"
...
Under the terms of the agreement, Apps is only required to provide the customer with a copy of the software product. The company must also provide technical support for a period of 24 months in consideration for $5,000.

Once the proprietary software is delivered to the customer, Apps has fulfilled its full contractual obligations (apart from being obliged to provide technical support). There is neither scope for a refund nor is there a policy of the company providing one as commercial practice.
...
Apps uses an accruals basis of recognising income for tax purposes.
...
Apps has undertaken all that is required under the contract with its customer upon delivery of the software and, therefore, the licence fee is derived at the time a recoverable debt arises in respect of the contractual fee in the 2024–25 year.

In contrast, with respect to the fee for technical services to be provided over 24 months, a contingency of repayment does exist in relation to the amount payable under the agreement (ie $5,000). In these circumstances, the point of derivation for the amount will occur progressively as the contingency of repayment lapses.

As a general rule, TR 2014/1 states that the quantum of exposure to contractual damages in such instances might be expected to diminish progressively on a straight line basis over the terms of the agreement.

Therefore, to reflect this, the amount of income that should be recognised for the 2024–25 year by Apps is $2,500 (which is referrable to the first 12 months of the service agreement). The balance of the fee would be assessed in the 2025–26 year.

The total amount assessed to Apps under the agreement for the 2024–25 year is $22,500 (ie $20,000 + $2,500).
