...
part: "2"
section: "2-300-small-business-cgt-concessions-meaning-of-active-and-excluded-assets"
...
Victoria is responsible for the bookings, checking guests in and out and cleaning the rooms. She also provides clean linen and meal facilities to guests. She does not enter into any lease agreements with guests staying at the apartments.

The rooms are collectively advertised as a bed and breakfast and are booked for periods ranging from one night to one month. The majority of bookings are from one to 7 nights.

Victoria also owns 2 commercial properties in the area which she leases to local businesses. The properties have been leased since acquisition under formal lease agreements to various commercial tenants. They have used them as office and warehouse spaces. The terms of the leases have ranged from one year to 3 years with a 3-year option; they are provided for exclusive possession. Victoria has not engaged a real estate agent to act on her behalf and manages the leasing of the properties by herself.

Due to financial difficulties, Victoria is considering disposing of one of her commercial properties.
...
- the taxpayer has owned the asset for 15 years or less and the asset was their active asset for at least
...
The period specified in s 152-35(2) begins when the taxpayer acquired the asset and ends at the earlier of:

- the CGT event, eg when the asset is being disposed of, and

- if the relevant business ceased to be carried on in the 12 months before that time or any longer period
...
There are however some specific exclusions from the asset being an active asset. These exclusions may extend to an asset whose main use by the taxpayer is to derive interest, an annuity, rent (unless the main use for deriving rent is only temporary), royalties or foreign exchange gains (ITAA97 s 152-40(4)(e)).
...
This approach is consistent with the views of the Commissioner in TD 2006/78 (see Example 1) and in accordance with Tingari. In the present case, each tenant is entitled to exclusive possession and quiet enjoyment of their respective properties and there is a landlord/tenant relationship. Therefore, as the premises are not active assets, Victoria would not be entitled to the CGT small business concessions if she were to sell either or both of these properties.
...
*Refs: ITAA97 s 152-35, s 152-35(2), s 152-35(1)), s 152-40(1)), ITAA97 s 152-40(4)(, s 152-40(4)(, s 152-35, s 152-10*