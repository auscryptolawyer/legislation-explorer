...
<a id="s40-832-1"></a>
- **(1)** You calculate your deduction for an income year for a project pool in this way if the project pool contains only *project amounts incurred on or after 10 May 2006 for projects that start to operate on or after that day: Pool value  200% DV project pool life where:
- 40-835 DV project pool life has the same meaning as in subsection
- 40-830(3). pool value has the same meaning as in subsection
- 40-830(3).
