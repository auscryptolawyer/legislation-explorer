...
<a id="s360-60-2"></a>
- **(2)** If, apart from those roll-overs, the entity (the original entity) mentioned in subsection
- 360-50(1) would continue to hold the *share (the original share) mentioned in that subsection, then subsections
- 360-50(2) to (5) apply as if:
