...
<a id="s355-447-2"></a>
- **(2)** The amount is worked out as follows: Total R&D deductions  Adjusted section
- 40-285 amount Total decline in value where: adjusted section
- 40-285 amount means so much of an amount equal to the section
- 40-285 amount as does not exceed the total decline in value. total decline in value means the *cost of the asset less its *adjustable value.
