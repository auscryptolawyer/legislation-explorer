...
<a id="s295-465-2"></a>
**(2)** A *complying superannuation fund can also deduct the amount it could reasonably be expected to pay in an *arm’s length transaction to obtain an insurance policy to cover it for that part of its current or contingent liabilities to provide benefits referred to in section 295-460 for which it does not have insurance coverage. It can deduct the amount for the income year when it has the liability. (2A) For the purposes of subsection (2), the regulations may provide that a specified proportion of an amount mentioned in subsection (2B) may be treated as being the amount the fund could reasonably be expected to pay in an *arm’s length transaction to obtain an insurance policy to cover it for its current or contingent liabilities to provide benefits referred to in section 295-460.
