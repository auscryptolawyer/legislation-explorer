...
<a id="s205-25-1"></a>
**(1)** An entity satisfies the residency requirement for an income year in which, or in relation to which, an event specified in a relevant table occurs if: Specialist liability rules Chapter 3 The imputation system Part 3-6 Franking accounts, franking deficit tax liabilities and the related tax offset Division 205 Section 205-30
