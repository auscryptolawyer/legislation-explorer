...
> <a id="s204-41-e"></a>
> **(e)** if some other benefit is specified—an amount worked out by multiplying the value of the benefit by the highest exempting Specialist liability rules Chapter 3 The imputation system Part 3-6 Anti-streaming rules Division 204 Section 204-45 percentage at which a distribution to a favoured member is franked.
