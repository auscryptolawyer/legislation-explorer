...
<a id="s320-37-2"></a>
**(2)** For the purposes of paragraph (1)(c), the foreign resident proportion of the *foreign establishment amounts is the amount worked out using the formula: Foreign resident foreign establishment Foreign establishment  policy liabilities amounts All foreign establishment policy liabilities where: all foreign establishment policy liabilities means the average value for the income year (as calculated by an *actuary) of the policy liabilities (as defined in the *Valuation Standard) for all *life insurance policies that: Specialist liability rules Chapter 3 Insurance business Part 3-35 Life insurance companies Division 320 Section 320-45
