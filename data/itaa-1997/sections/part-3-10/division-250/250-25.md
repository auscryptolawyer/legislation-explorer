...
> <a id="s250-25-1-b"></a>
> **(b)** in relation to the *tax preferred use of the asset or any other asset that is being, or is to be, put to a tax preferred use under the arrangement; Specialist liability rules Chapter 3 Financial transactions Part 3-10 Assets put to tax preferred use Division 250 Section 250-30 does not exceed $5 million.
