...
<a id="s230-425-3"></a>
**(3)** An election under subsection 230-395(1) ceases to apply to a *financial arrangement from the start of an income year if the arrangement ceases to satisfy a requirement of paragraph 230-410(1)(c), (d), (e) or (f) during that income year. Specialist liability rules Chapter 3 Financial transactions Part 3-10 Taxation of financial arrangements Division 230 Section 230-430
