...
<a id="s243-55-2"></a>
- **(2)** The *capital allowance deduction is reduced if the amount that would have been worked out under subsection
- 243-35(2) would have exceeded the amount worked out under subsection
- 243-35(4) if the following assumptions were applied in both subsections: Assumptions to be applied
