...
<a id="s240-60-3"></a>
**(3)** In calculating the implicit interest rate, if any of the relevant amounts are not known at the start of the *arrangement, a reasonable estimate of the amount is to be made and is to be used
