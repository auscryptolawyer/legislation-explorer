...
<a id="s27-95-1"></a>
**(1)** The *termination value of a *depreciating asset is reduced if the relevant *balancing adjustment event is a *taxable supply. The reduction is an amount equal to the *GST payable on the supply. Chapter 2 Rules about deductibility of particular kinds of amounts Part 2-5 Effect of input tax credits etc. on deductions Division 27 Section 27-100
