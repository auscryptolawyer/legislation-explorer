...
<a id="s152-325-3"></a>
- **(3)** If a payment is made to more than one *CGT concession stakeholder, the amount of each such payment is to be worked out by reference to each individual’s percentage (see subsection
- 152-315(5)) of the relevant *CGT exempt amount. (3A) If the *CGT concession stakeholder to whom the payment is made is an employee of the company or trust, the payment must not be of a kind mentioned in section
- 82-135 (disregarding paragraph (fa) of that section).
