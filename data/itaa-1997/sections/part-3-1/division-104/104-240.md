...
<a id="s104-240-1"></a>
**(1)** You make a capital gain if the *termination value of the *depreciating asset covered by subsection 104-235(1) or (1B) is more than its *cost. The amount of the *capital gain is: é ù Sum of reductions ê * Termination value – *Cost ú ´ ë û Total decline where: sum of reductions is the sum of:
...
<a id="s104-240-2"></a>
**(2)** You make a capital loss if the *cost of the *depreciating asset covered by subsection 104-235(1) or (1B) is more than its *termination value. The amount of the *capital loss is: Specialist liability rules Chapter 3 Capital gains and losses: general topics Part 3-1 CGT events Division 104 Section 104-245 é ù Sum of reductions ê *Cost – * Termination value ú ´ ë û Total decline where: sum of reductions and total decline have the same meanings as in subsection (1).
