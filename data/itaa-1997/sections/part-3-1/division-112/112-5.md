...
<a id="s112-5-4"></a>
**(4)** Subdivision 112-B (which is a guide) has a number of tables (each one covering a specialist topic) that tell you each situation that may result in a modification to the general rules. Specialist liability rules Chapter 3 Capital gains and losses: general topics Part 3-1 Modifications to cost base and reduced cost base Division 112 Section 112-15
