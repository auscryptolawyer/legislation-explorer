...
<a id="s815-225-1"></a>
- **(1)** The arm’s length profits for a *PE of an entity are worked out by allocating the actual expenditure and income of the entity between the PE and the entity so that the profits attributed to the PE equal the profits the PE might be expected to make if: International aspects of income tax
