...
<a id="s820-870-6"></a>
**(6)** The *TC indirect control interest is the result of applying the following method statement if there are more than 2 interposed entities between the top entity and the company, trust or partnership at that time. Method statement Step 1. Calculate the *TC control tracing interest that the top entity holds in the first of those interposed entities at that time.
