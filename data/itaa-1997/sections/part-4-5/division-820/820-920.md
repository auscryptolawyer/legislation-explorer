...
<a id="s820-920-4"></a>
**(4)** The *associate entity’s attributable safe harbour excess amount at a particular time during that period is the result of applying the method statement in this subsection. In applying the method statement, disregard any amount that is attributable to an entity’s International aspects of income tax Chapter 4 General Part 4-5 Thin capitalisation rules Division 820 Section 820-920 *overseas permanent establishments if it is an *outward investing financial entity (non-ADI) at that time. Method statement Step 1. Work out the *safe harbour debt amount of the *associate entity for the day during which that particular time occurs, as if the associate entity were an *outward investing financial entity (non-ADI) or *inward investing financial entity (non-ADI), as appropriate, for the period consisting only of that day. Step 2. Reduce the result of step 1 by the value of the *adjusted average debt of the *associate entity for that day as if it had been the kind of entity that it is taken to be under step 1 for that day. If the result of this step is a negative amount, it is taken to be nil. Step 3. Multiply the result of step 2 by the sum of:
