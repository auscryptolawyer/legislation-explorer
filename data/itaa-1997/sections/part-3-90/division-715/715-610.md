...
<a id="s715-610-1"></a>
**(1)** This section reduces to nil a loss that would otherwise be *realised for income tax purposes by a *realisation event that happens to an *equity or loan interest (the realised interest) in an entity (the first entity) when it is owned by another entity (the owner), if the conditions in subsections (2) and (4) are met. Specialist liability rules Chapter 3 Consolidated groups Part 3-90 Interactions between this Part and other areas of the income tax law Division 715 Section 715-610
