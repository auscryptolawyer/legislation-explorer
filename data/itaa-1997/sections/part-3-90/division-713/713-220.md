...
<a id="s713-220-1"></a>
**(1)** This section applies if an entity (the joining entity) that is a partner in a partnership becomes a *subsidiary member of a *consolidated group at a time (the joining time). Specialist liability rules Chapter 3 Consolidated groups Part 3-90 Rules for particular kinds of entities Division 713 Section 713-225
