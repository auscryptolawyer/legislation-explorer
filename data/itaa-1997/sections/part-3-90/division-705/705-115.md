...
<a id="s705-115-1"></a>
**(1)** For the purposes of step 7 in the table in section 705-60, the step 7 amount is worked out using the following formula:   Owned deductions +  Acquired deductions  *Corporate tax rate    where:
...
<a id="s705-115-3"></a>
- **(3)** Subsection (2) does not cover a deduction under section
- 705-125 How to work out a pre-CGT factor for assets of joining entity
