...
<a id="s315-210-2"></a>
**(2)** The first element of the *cost base and *reduced cost base of the *CGT asset is worked out under the method statement. Method statement Step 1. Start with the *market value of the demutualising health insurer on the day the asset is issued. Step 2. Divide the result of step 1 by the sum of:
